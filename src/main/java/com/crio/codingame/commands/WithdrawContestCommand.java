...
public class WithdrawContestCommand implements ICommand{
    ...
    {
        UserRegistrationDto userRegisterationStatus;
        try
        {
            userRegisterationStatus = userService.withdrawContest(tokens.get(1), tokens.get(2));
            System.out.println(userRegisterationStatus);
        }
        catch(Exception e)
        {
